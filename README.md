...
- **Best honest cross-fit blend (current leader)**: **nb429** — SLSQP combo of router predictors (active deploy weights nb424 ~0.61, nb427 ~0.39), pooled 5-fold cross-fit RAE on the 253 unblind = **0.5550** (beats nb424 0.5556 and nb400 0.5698). nb425 (scaffold router, 0.5834) and nb426 (external-anchor router, 0.5811) did not pass the <0.56 promotion bar.
