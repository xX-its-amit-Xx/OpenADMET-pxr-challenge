...
- **Best honest cross-fit RAE achieved: 0.5283** (nb492 alt-anchor residual router on nb464; beats nb481 0.5349 by −0.0066; the multi-anchor sweep confirms residual-LGBM routing transfers across anchors, with nb464 > nb420 > nb432 > chemprop_aux in honest RAE order). Honest expected LB band **0.52–0.57**.
