...
- **Best honest cross-fit RAE achieved: 0.5349** (nb481 extended residual-stack-router; beats nb472 0.5410 by −0.0061; nb472's in-sample refit 0.4281 vs honest 0.5410 quantifies the **curriculum-overfit-gap at +0.1129 RAE**, so any 0.42-0.48 in-sample number on 253 rows overstates LB by ≥0.10). Honest expected LB band **0.53–0.58**.
