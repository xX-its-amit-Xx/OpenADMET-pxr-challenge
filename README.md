...
- **Best honest cross-fit RAE achieved: 0.5410** (nb472 residual-stack-router, LGBM on nb432 residual with err_hat-gated soft correction; in-sample refit 0.4281 is an overfit upper bound). Honest expected LB band **0.54–0.58**.
