"""Run nb111-nb113: enhanced delta, blend optimizer, counter-assay delta.

nb111 — 3-Tier Delta with Enhanced Features (ECFP6 + MACCS + extended physchem)
nb112 — Pairwise Blend Optimizer (exhaustive 2/3-model grid search)
nb113 — Counter-Assay Informed Delta (use null-activity as delta feature)
"""
...
NOTEBOOKS = [
    "111_delta_enhanced_features.ipynb",
    "112_pairwise_blend_optimizer.ipynb",
]
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run phase v10 notebooks (nb111-nb112)")
    ...
    print("=" * 60)
    print("Phase v10 runner  (nb111-nb112 enhanced delta + blend optimizer)")
