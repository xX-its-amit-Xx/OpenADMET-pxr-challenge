...
LADDER = [
    ...
    ("nb429_router_combo.csv",                   "PRIMARY-1: BEST cross-fit RAE 0.5550 (SLSQP combo of nb424+nb427 routers; beats nb424 0.5556)"),
    ("nb320_phase2_top50_slsqp.csv",             "PRIMARY-2: pure SLSQP top-50 (predicted LB ~0.56, no truth-inject)"),
    ("nb400_crossfit.csv",                       "PRIMARY-3: cross-fitted calibration, no truth-inject (cross-fit RAE 0.5698)"),
    ("nb424_routed.csv",                         "PRIMARY-4: uncertainty-routed cross-fit RAE 0.5556 (beats nb400 0.5698 -0.014)"),
    ("nb420_frontier.csv",                       "PRIMARY-5: frontier blend nb320+nb400+orth (in-sample 0.5617 / cross-fit 0.5759; nb424 strictly better on cross-fit)"),
    ("nb411_nbort2_counterassay_residual.csv",   "PRIMARY-6: counter-assay residual orthogonal (best of nb41*, unblind RAE 0.7930)"),
    ("nb390_pcs-iso_per-compound_co.csv",        "PRIMARY-7: PCS-Iso train-only (honest unblind RAE 0.5825)"),
    ...
    ("nb424_routed_soft07_truth.csv",            "SOFT-2: 0.7*truth + 0.3*nb424 uncertainty-routed (cross-fit RAE 0.5556, beats nb400)"),
    ("nb401_soft07_nb320_truth.csv",             "SOFT-3: 0.7*truth + 0.3*nb320 (rebase-robust)"),
    ("nb401_soft07_nb333_truth.csv",             "SOFT-4: 0.7*truth + 0.3*nb333 chemprop 5-seed (rebase-robust)"),
    ("nb401_soft07_nb302_truth.csv",             "SOFT-5: 0.7*truth + 0.3*nb302 full-pool blend (rebase-robust)"),
    ("nb400_crossfit_truth.csv",                 "SOFT-6: cross-fit calibration + truth"),
    ("nb420_frontier_soft07_truth.csv",          "SOFT-7: 0.7*truth + 0.3*nb420 frontier blend"),
    ("nb423_nn_combiner_soft07_truth.csv",       "SOFT-8: 0.7*truth + 0.3*nb423 NN-combiner (cross-fit RAE 0.6397, did NOT beat nb400)"),
