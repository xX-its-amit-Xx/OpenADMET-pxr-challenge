"""Run nb97, nb98, nb99, nb102: multi-template delta, scaffold-aware kNN,
consensus delta-ML, and stochastic bootstrap ensemble."""
...
NOTEBOOKS = [
    "97_multi_template_delta.ipynb",
    "98_scaffold_aware_knn.ipynb",
    "99_consensus_delta_ml.ipynb",
    "102_stochastic_ensemble.ipynb",
]
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run phase v7 notebooks (nb97-102)")
    ...
    parser.add_argument("--notebooks", nargs="+", default=None,
                        help="Run specific notebooks only (e.g. 97_multi_template_delta.ipynb)")
